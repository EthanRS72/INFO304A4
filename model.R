...
# Example use:  (not run)
#
# Assume that we have some hospital data called cA
# Single run:
# test.lm(cA, LOS ~ AGE_ADM + GENDER + HLTHSPEC, perc.train=0.9)
#
# Multiple runs:
#
# errs <- replicate(50,test.lm(cA, LOS ~ AGE_ADM + GENDER + HLTHSPEC, perc.train=0.9))
#
